...
init python:
    ...
    game_resolution_pixel = (480, 270)
    pixel_ratio = game_resolution[0] / game_resolution_pixel[0]
    gui.init(*game_resolution)

    def p(width: int = None, height: int = None): 
        if width is not None and height is not None:
            return (width / game_resolution_pixel[0], height / game_resolution_pixel[1])
        elif width is not None:
            return width / game_resolution_pixel[0]
        elif height is not None:
            return height / game_resolution_pixel[1]
        else:
            return 0.0
...
# Text scale setting set in preferances screen
...
define gui.textbox_yalign = p(height=269)
...
# TODO create seperate choice buttons for World Map
define gui.choice_button_width = 650 # 1185
