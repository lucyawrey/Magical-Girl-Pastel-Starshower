...
label void_heart_story:
    ...
    stella "Sorry."
    ellie "It's okay! I know you were busy saving the city and all, doesn't suprise me you forgot you said you'd meet me."
    stella "I still shouldn't have forgot."
    ellie "Well I forgive you then. Now come on, tell me about when you killed the President of the United States!"

    stella "Hehe you can't just come out and say that. But fine, let me set the scene."
    play music dream volume 0.8
    ...
    mgvh "Will you try to pick up the crown you called democracy?"
    stella "The woman shook her head, and no one else died that day."

    ellie "Wow, you really go for a dramatic tone when you finally open up."
